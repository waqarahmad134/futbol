  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <Link to="/privacy-policy">Privacy Policy</Link> for the full details.
      </p>

      <h2>Start playing</h2>
      <p>
        Jump into popular games like the <Link to="/game/futbol-grid">Football Grid</Link>,{" "}
        <Link to="/game/futbol11-wordle">Futbol11 Wordle</Link>,{" "}
        <Link to="/game/futbol11-connections">Connections</Link>, or{" "}
        <Link to="/game/futbol11-higher-lower">Higher or Lower</Link> — or browse the full lineup on
